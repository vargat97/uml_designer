...
namespace MetaDslx.GraphViz
{
    ...
    public class NodeLayout
    {
        ...
        public NodeLayout AddNode(object nodeObject)
        {
            ...
            if (_graph.FindNodeLayout(nodeObject) != null)
            {
                //throw new InvalidOperationException("The graph already contains this node.");
                return _graph.FindNodeLayout(nodeObject);
            } 
